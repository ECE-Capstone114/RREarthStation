...
def main():
    ...
    for p in passes:
        ...
        if len(passes[p]) > 1:
            for i in range(0, len(passes[p])):
                print(str(i) + ')\tRises:\t', t[passes[p][i][0]].astimezone(tzone), 'PST')
                print('\tSets:\t', t[passes[p][i][1]].astimezone(tzone), 'PST')
                print('\n')
        else:
            print('0)\tRises:\t', t[passes[p][0][0]].astimezone(tzone), 'PST')
            print('\tsets:\t', t[passes[p][0][1]].astimezone(tzone), 'PST')
            print('\n')
    ...
    print(t[pass_sched[pass_num][0]].astimezone(tzone), 'PST to', t[pass_sched[pass_num][1]].astimezone(tzone), 'PST')
    print('\n')
